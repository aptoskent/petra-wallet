...
export const config: WebdriverIO.Config = {
  ...
  // retried immediately or deferred to the end of the queue
  ...
  // it and to build services around it. You can either
  // apply a single function or an array of
