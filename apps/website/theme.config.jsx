import { PetraLogoWithText } from './core/components/Header';

/**
 * @see https://nextra.site/docs/docs-theme/theme-configuration
 */
export default {
  logo: <PetraLogoWithText />,
  project: {
    link: 'https://github.com/aptos-labs/petra-wallet',
  },
  chat: {
    link: 'https://twitter.com/PetraWallet',
  ...
  feedback: {
    useLink: () => "https://github.com/aptos-labs/petra-wallet/issues/new"
  },
  editLink: {
    text: <></>
  },
  footer: {
    text: <span>
      © 2023 <a target="_blank" href="https://aptoslabs.com">Petra</a>. All Rights Reserved.
    </span>,
  },
  useNextSeoProps: () => {
    return {
