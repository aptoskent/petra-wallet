...
export default class WindowStorage<TState> implements StorageInterface<TState> {
...
export function makeWindowPersistentStorage() {
  return new WindowStorage<PersistentState>(window.localStorage);
}

export function makeWindowSessionStorage() {
  return new WindowStorage<SessionState>(window.sessionStorage);
}
