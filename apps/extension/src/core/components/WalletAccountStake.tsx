...
import { useAccountStakeBalance } from '@petra/core/queries/account';
...
function WalletAccountStake() {
  ...
  const { data: stakeBalance, isLoading } = useAccountStakeBalance(
      ...
      <Wrap alignItems="baseline">
        <span>
          {isLoading ? (
            ...
            <Heading fontSize="md" as="span" wordBreak="break-word" maxW="100%">
              {stakeBalanceString}
            </Heading>
          )}
