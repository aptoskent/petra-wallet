 ...
 */
export function GraceHopperBoringAvatar({ type = 'beam' }: BoringAvatarProps) {
  const marble = (
    <svg
      viewBox="0 0 80 80"
      fill="none"
    ...
    >
      ...
      <g mask="url(#mask__marble)">
        ...
        <path
          ...
          fill="#bda0a2"
          transform="translate(0 0) rotate(-88 40 40) scale(1.2)"
        />
        <path
          filter="url(#prefix__filter0_f)"
          d="M22.216 24L0 46.75l14.108 38.129L78 86l-3.081-59.276-22.378 4.005 12.972 20.186-23.35 27.395L22.215 24z"
          fill="#ffe6db"
          transform="translate(4 4) rotate(132 40 40) scale(1.2)"
